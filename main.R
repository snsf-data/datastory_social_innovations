...
datastory_name <- "social_innovations"
...
# characters etc.)
# -> Don't put "datastory" at the start or end!
datastory_name_en <- "social-innovations"
datastory_name_de <- "soziale-innovationen"
datastory_name_fr <- "innovations-sociales"

# English title and lead of the story (Mandatory, even if no EN version)
title_en <- "Integrating research into practice"
lead_en <- "Across all disciplines, research results from SNSF-funded projects find their way into practice and create connections between science and society. But what exactly do these connections look like?"
# German title and lead of the story (Mandatory, even if no DE version)
title_de <- "Wie viel Forschung kommt in die Praxis?"
lead_de <- "In allen Fachdisziplinen finden Forschungsergebnisse aus SNF-geförderten Projekten ihren Weg in die gelebte Praxis und verknüpfen Wissenschaft mit Gesellschaft. Aber wie genau sieht diese Verknüpfung aus?"
# French title and lead of the story (Mandatory, even if no FR version)
title_fr <- "De l’intégration de la recherche dans la pratique"
lead_fr <- "Les résultats issus des projets encouragés par le FNS trouvent des applications pratiques dans toutes les disciplines et jettent ainsi un pont entre science et société. Mais quelle forme cette relation prend-elle exactement ?"
# Contact persons, always (first name + last name)
contact_person <- c("Marlene Lanzerstorfer", "Simon Gorin")
...
publication_date <- "2024-05-30 12:00:00"
...
doi_url <- "https://doi.org/10.46446/datastory.social-innovations"
